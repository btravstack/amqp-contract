...
let versions: VersionMenu;
try {
  versions = JSON.parse(raw) as VersionMenu;
} catch (cause) {
  // Machine-generated by deploy-docs.yml, so this means the workflow is broken.
  // Name the variable and echo the value — a bare SyntaxError here says neither.
  console.error(
